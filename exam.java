...
public class exam extends JPanel {
	...
	private static double ballSpeedX = 4; // Ball's speed for x and y
	private static double ballSpeedY = 4;
				...
				while (true) { // Execute one update step>
					...
					if(ballSpeedY>0) {
						...
						if (ballSpeedY>=0) {
							...
							ballY = ballRadius; // Re-position the ball at the edge
						}
