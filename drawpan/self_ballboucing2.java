...
import javax.swing.JFrame;
 ...
 public class self_ballboucing2 extends JFrame implements MouseMotionListener,MouseListener{
...
//     double n = -1;
     ...
     public void paint(Graphics g) {
         ...
         g2d.fillOval(x, y, 400, 100);
         g2d.setColor(Color.RED);
         g2d.fillOval(a, b, size, size);
         g2d.setColor(Color.WHITE);
         g2d.fillOval(225,375,50,50);
         g2d.setColor(Color.BLACK);
         g2d.drawLine(momcenter_x,momcenter_y,stick_x,stick_y);
     }
     //定?小球移???
     public void move(){
         while(true){
